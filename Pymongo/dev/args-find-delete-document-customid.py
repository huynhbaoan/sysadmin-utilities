...
BEGIN_DATE_RAW = mylib.resume_customid(BACKUP_PATTERN, INDEX_PATTERN, collection)
...
while (DATE_RAW <= END_DATE_RAW): 
    ...
    mylib.backup_delete_docs_customid(BACKUP_PATTERN, INDEX_PATTERN, BEGIN_DAY, BEGIN_MONTH, BEGIN_YEAR, DAY, MONTH, YEAR, collection, BEGIN_PART_NUM)
